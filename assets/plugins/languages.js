...
let originalTexts = {
    ...
    'resume_pe2_exp4': "Responsável pela manutenção de sistemas monolíticos e APIs desenvolvidas em Django, como geração de diplomas, agendamento de aulas e elaboração de planos de ensino, atuando na correção de bugs, melhoria contínua e implementação de novos requisitos;",
    'resume_pe2_exp5': "Participei da implantação de novos sistemas que integram dados legados, como o histórico de agendamentos, possibilitando a geração automatizada de registros de atuação docente.",
...
let translatedTexts = {
    ...
    'resume_pe2_exp4': "Responsible for maintaining monolithic systems and APIs developed in Django, including diploma generation, class scheduling, and lesson planning systems, performing bug fixes, continuous improvements, and implementing new requirements;",
    'resume_pe2_exp5': "Contributed to the implementation of new systems that integrate legacy data, such as scheduling history, enabling the automated generation of teaching activity records.",
